...
function lptw_display_recent_posts ( $atts ) {
    ...
    if( $lptw_shortcode_query->have_posts() ) {
        ...
        while( $lptw_shortcode_query->have_posts() ) {
            ...
            $color = sprintf('#%06x',rand(0,16777215)); //Color del borde de fotografia al azar
            ...
            if ($a['layout'] == 'basic' ) {
                if ($url != '') {
                    ...
                    $img_content = '<img src="'.$url.'" alt="'.get_the_title().'" class="fluid" style="border: 4px solid '.$color.';"/>';
